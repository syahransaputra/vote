          ...
          <div class="card-body emails-list-header p-3 py-lg-3 py-2">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex align-items-center mb-0 mb-md-2">
                ...
                <div class="dropdown">
                  <i class="bx bx-dots-vertical-rounded cursor-pointer bx-sm" id="emailsActions" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  </i>
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
                ...
                <div class="dropdown me-2">
                  <i class="bx bx-folder cursor-pointer" id="dropdownMenuFolder" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
                ...
                <div class="dropdown">
                  <i class="bx bx-purchase-tag cursor-pointer" id="dropdownLabel" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  </i>
          ...
          <div class="d-flex justify-content-between align-items-center py-2">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="dropdown ms-3">
                <i class="bx bx-dots-vertical-rounded cursor-pointer" id="dropdownMoreOptions" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                </i>
          ...
          <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
              ...
              <div class="dropdown me-3">
                <i class="bx bx-folder cursor-pointer" id="dropdownMenuFolder" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                </i>
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuFolder">
                  <a class="dropdown-item" href="javascript:void(0)">
                    <i class="bx bx-error-circle bx-xs me-1"></i>
          ...
          <div class="card email-card-prev mx-sm-4 mx-3 border shadow-none">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="dropdown me-3">
                  <i class="bx bx-dots-vertical-rounded cursor-pointer fs-4" id="dropdownEmail" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  </i>
          ...
          <div class="card email-card-last mx-sm-4 mx-3 mt-4 border shadow-none">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
              ...
              <div class="d-flex align-items-center">
                ...
                <i class="email-list-item-bookmark bx bx-star cursor-pointer me-2 fs-4"></i>
                <div class="dropdown me-3">
                  <i class="bx bx-dots-vertical-rounded cursor-pointer fs-4" id="dropdownEmail" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownEmail">
                    <a class="dropdown-item scroll-to-reply" href="javascript:void(0)">
                      <i class="bx bx-share me-1"></i>
                      <span class="align-middle">Reply</span>
